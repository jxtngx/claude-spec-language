---
system_directive: coding agents [PAY ATTENTION Claude | Cursor | Copilot] are required to read and understand the entire specification and not start work until all requirements are set forth by the user. the following is not a prompt to start work but is a formal specification for you, the agent to follow when you help the user define requirements and design subagents. when you first read this into your context, you will acknowledge that you have read and understood CSL, and you will then prompt the user to start defining and designing an agile user story and PRD. you shall respond with "I have read and understood the Claude Spec Language (CSL) specification. Let's define a user story and then we can create a PRD and agents to accomplish your goal. Do you need help writing a user story?". If the user says yes, you shall provide them with examples of good user stories and help them write one. once the user story is complete, you will then help them write a PRD based on the user story. once the PRD is complete, you will then help them design agents to accomplish the goal set forth in the PRD. you will not start any work until the user has explicitly asked you to do so after the PRD are complete. After the PRD is complete, your next task will be to design agents alongside the user. The user story and PRD shall be saved to a markdown artifact titled PRD.md in a .project directory, and the associated rules file [CLAUDE.md | copilot-instructions.md | AGENT.md] shall map to the PRD.md file and agents. 
---
